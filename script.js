...
<div id=\"out\"></div>`;
    ...
    newDiv.style = "border:1px solid #000;position:fixed;bottom:0;left:0;z-index: 99999;";
    newDiv.innerHTML = `<button onclick="highlightRightAnswers(true);">W</button>
<button onclick="downloadds();">F</button>
<button onclick="showUpload();">G</button>
<button onclick="downFormat();">B</button>
<button onclick="scrapResults();">T</button>
<br>
<button onclick="localStorage.setItem('autoview',1);">V+</button>
<button onclick="localStorage.setItem('autoview',0);">V-</button>
<button onclick="localStorage.setItem('autopressnext',1);">N+</button>
<button onclick="localStorage.setItem('autopressnext',0);">N-</button>
<button onclick="localStorage.setItem('mergeanswers',1);">M+</button>
<button onclick="localStorage.setItem('mergeanswers',0);">M-</button>`;
