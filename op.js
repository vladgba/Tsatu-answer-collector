...
(function (window, undefined) {
    ...
    imgReg=/http:\/\/op\.tsatu\.edu\.ua\/pluginfile\.php\/([0-9]{0,9})\/question\/([a-z]{0,20})\/([0-9]{0,9})\/([0-9]{0,9})\/([0-9]{0,9})\//;
    //op.tsatu.edu.ua/pluginfile.php/2452/question/answer/13183/10/210879/image001.png
    /*
*************************************************************************
        ...
        partis.forEach((part) => {
            ...
            for(var i=0;i<answRight.length;i++){
                ...
                if((Question.localeCompare(answRight[i][0].replace(/<[^>]+>/g,'')))==0) {
                    ...
                    Quest.style="background:#0000ff;color:#fff";
                }
            ...
            if (patchSelected){
                Answers.forEach((element) => {
                    ...
                    //Upd 05.10
                    answo.querySelector('span.answernumber').remove();
    ...
    function parseFinish(){
        ...
        Questions.forEach((part) => {
            ...
            if(rAnsw==null){
                ...
                RightAnswer=RightAnswer.replace(new RegExp('The correct answer is: '),'').replace(new RegExp('Ваша відповідь (не )?правильна'),'');
...
*/
    ...
    //             IN FINISH TEST
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //http://op.tsatu.edu.ua/mod/quiz/summary.php
    if (/http:\/\/op\.tsatu\.edu\.ua\/course\/view\.php/.test(w.location.href)) {
        ...
        if (/http:\/\/op\.tsatu\.edu\.ua\/mod\/quiz\/summary.php/.test(w.location.href)) {
            ...
            document.addEventListener('keydown', function(event) {
                ...
                if (event.code == 'KeyD') {
                    document.querySelector(".moodle-dialogue .btn-primary").click();
                }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (/http:\/\/op\.tsatu\.edu\.ua/.test(w.location.href)) {
            document.addEventListener('keydown', function(event) {
                ...
                if (event.code == 'KeyR') {
                    var qsts=document.querySelectorAll(".que");
                    qsts.forEach((el) => {

                        var selected=el.querySelectorAll(".content [type=radio]");
                        var selectedb=el.querySelectorAll(".content [type=checkbox]");
                        var rp;
                        var rpw;
